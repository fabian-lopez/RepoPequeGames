...
function disparaEnemigo(){
	...
	//tiempoDisparo -= 10;
	//if(tiempoDisparo<100) tiempoDisparo = 100;
}
/*************
LISTENER
**************/
...
window.onload = function(){
	...
	if(canvas && canvas.getContext){
		...
		if(ctx){
			...
			mensaje("INVASORES");
			 imagen = new Image();
			 imagenEnemigo = new Image(); /*--------------------IMAGENES -----------------*/
			 imagenEnemigo.src = "/static/imgs/img_nave/invader.fw.png";
			 imagen.src = "/static/imgs/img_nave/torre.fw.png";
